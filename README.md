...
- 🐍 🦀 🎓 [melaya-labs/melaya](https://github.com/melaya-labs/melaya) — Agentic platform with native MCP client support: any crew can attach tools from any MCP server (stdio or HTTP/SSE) and compose them alongside 265 first-party scoped tools. Adds HITL gating, scheduling, and replay around every MCP tool call.
## Frameworks
